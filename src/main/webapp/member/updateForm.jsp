...
<form name="updateForm" id="updateForm">
	<h1>
		<img src="../image/4.jpg" width="100" height="100" alt="홈" 
			 onclick="location.href='${ pageContext.request.contextPath }/index.jsp'" style="cursor: pointer;"> 회원정보수정
	</h1>
	<table border="1">
		<tr>
	        <th width="100">이름</th>
	    ...
	    <tr>
	        <th>이메일</th>
	        <td>
	        	<input type="email" name="email1" value="${fn:split(sessionScope.memDTO.email, '@')[0]}">
	        	@
	    ...
	    <tr>
	    	<th>주소</th>
	    	<td>
	    		<input type="text" name="zipcode" id="zipcode" size="6" readonly value="${sessionScope.memDTO.zipcode}">
	    		<button type="button" onclick="checkPost(); return false;">우편번호 검색</button><br/>
	    		<input type="text" name="addr1" id="addr1" size="60" readonly value="${fn:split(sessionScope.memDTO.address, ',')[0]}"><br/>
	    		<input type="text" name="addr2" id="addr2" size="60" value="${fn:split(sessionScope.memDTO.address, ',')[1]}">
	    	</td>
	    </tr>
