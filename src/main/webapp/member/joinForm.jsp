            ...
            <div class="modal-body">
                <form id="joinForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="repwd" placeholder="비밀번호 입력">
                    </div>
					<div class="form-group">
						<label for=gender>성별</label> <input type="radio"
							class="form-control" id="gender" name="gender" checked="checked"
							placeholder="비밀번호 입력">
					</div>
					<div class="form-group">
						<label for=email>이메일</label> <input type="email" name="email1">
						@ <input type="text" name="email2" id="email2"> <input
							type="email" name="email3" id="email3" list="email3_list"
							oninput="change()">
					...
					<div class="form-group">
						<label for="address">주소</label> <input type="text" name="zipcode"
							id="zipcode" size="6" readonly placeholder="우편번호">
						<button type="button" onclick="checkPost(); return false;">우편번호
							검색</button>
						<br /> <input type="text" name="addr1" id="addr1" size="60"
							readonly placeholder="주소"><br /> <input type="text"
							name="addr2" id="addr2" size="60" placeholder="상세주소">
						<div id="addrDiv"></div>
					</div>
